...
{
	viewfinder_scr = lv_obj_create(lv_layer_top(), NULL);
	lv_obj_set_size(viewfinder_scr, 480, 272);
	lv_obj_set_style_local_border_width(viewfinder_scr, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 0);
	lv_obj_set_style_local_radius(viewfinder_scr, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 0);
	lv_obj_set_style_local_bg_opa(viewfinder_scr, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_TRANSP);
	...
	lv_obj_t *action_btn = lv_btn_create(viewfinder_scr, NULL);
	lv_obj_add_style(action_btn, LV_BTN_PART_MAIN, &btn_style);
	lv_obj_set_size(action_btn, 55, 55);
	lv_obj_align(action_btn, viewfinder_scr, LV_ALIGN_IN_RIGHT_MID, -10, 0);
	...
	lv_obj_t *gallery_btn = lv_obj_create(viewfinder_scr, switch_mode_btn);
	lv_obj_align(gallery_btn, viewfinder_scr, LV_ALIGN_IN_BOTTOM_RIGHT, -10, -10);
	...
	lv_obj_t *setting_btn = lv_obj_create(viewfinder_scr, switch_mode_btn);
	...
	lv_obj_align(setting_btn, viewfinder_scr, LV_ALIGN_IN_TOP_LEFT, 10, 10);
